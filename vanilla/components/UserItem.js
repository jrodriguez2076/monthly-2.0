...
var UserItem = function UserItem(props) {
  ...
  var deleteItem = function deleteItem() {
    ...
    var userDeleteRequest = new Request("/api/users", {
      method: 'DELETE',
    ...
    fetch(userDeleteRequest).then(function (data) {
      return data;
    }).then(function (res) {
      props.updateUsers();
      toggle();
  ...
  var userMapper = props.users.map(function (item, i) {
    return _react["default"].createElement("div", {
      ...
      tag: "h3"
    }, item.name), _react["default"].createElement(_reactstrap.CardText, null, item.email), _react["default"].createElement(_reactstrap.Button, {
      color: "link",
      style: {
        padding: "1rem"
      },
